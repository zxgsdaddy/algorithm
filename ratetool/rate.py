...
def cal(money, proportion, float_rate, total_month):
    '''
    :param money: 可使用资金
...
def buy(money, loan_life):  # 计算 首套 和 二套的情况
    print("可使用资金 %s" % money)
    print("二套".center(30, "-"))
    cal(money, 0.7, 0.25, loan_life * 12)
    print("".center(30, "-"))
    cal(money, 0.6, 0.25, loan_life * 12)
    print('首套'.center(30, "-"))
    cal(money - 50 * 10000 + total_payment(50 * 10000, 0.048 * (1 + 0.05), 30 * 12, 12 * 2), 0.3, 0.2, loan_life * 12)
